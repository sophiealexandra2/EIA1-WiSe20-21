...
console.log('Für Nord Amerika hat sich 2018 im Vergleich zu 2008 die Emission um' +  Math.round(northamerica18/northamerica08*100) + '% verändert');
...
console.log('Für Asien hat sich 2018 im Vergleich zu 2008 die Emission um' +  Math.round(asia18/asia08*100) + '% verändert');
...
console.log('Für Australien hat sich 2018 im Vergleich zu 2008 die Emission um' +  Math.round(australia18/australia08*100) + '% verändert');
